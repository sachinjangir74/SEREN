...
const programs = [
  {
    ...
    modules: [
      { title: 'Understanding Your Stress', description: 'Identify physical and emotional signs of stress and pinpoint your core triggers.', duration: 'Week 1', content: 'Stress is a normal physiological response, but chronic stress can be harmful. We explore the fight-or-flight response and how it manifests in your life.' },
      { title: 'The Power of Perspective', description: 'Learn cognitive reframing techniques to change how you perceive and react to stressful situations.', duration: 'Week 2', content: 'Our reaction to stress is often dictated by our interpretation of events. We introduce CBT techniques to identify thought distortions and practice reframing them.' },
      { title: 'Actionable Relaxation Techniques', description: 'Master practical methods to calm your nervous system in the moment.', duration: 'Week 3', content: 'This week focuses on physiological regulation. We practice square breathing, progressive muscle relaxation (PMR), and grounding exercises.' },
      { title: 'Building Sustainable Resilience', description: 'Create a personalized stress management plan for long-term well-being.', duration: 'Week 4', content: 'Resilience is a muscle that can be strengthened. We focus on lifestyle factors and create a sustainable, personalized Stress First-Aid Kit for future challenges.' }
    ],
    isActive: true
  },
  {
    ...
    modules: [
      { title: 'The Physiology of Breath', description: 'Understand how breathing directly impacts your nervous system and emotions.', duration: 'Week 1', content: 'You will learn the science behind why deep, diaphragmatic breathing calms the vagus nerve. We practice the basic belly breath technique.' },
      { title: 'Advanced Breathing Techniques', description: 'Learn practical methods like 4-7-8 breathing and box breathing for specific situations.', duration: 'Week 2', content: 'The 4-7-8 method is excellent for sleep preparation, while box breathing is ideal for regaining focus during high-stress moments.' }
    ],
    isActive: true
  },
  {
    ...
    slug: 'anxiety-relief',
    description: 'A 6-week structured program using evidence-based techniques to help you understand, manage, and reduce anxiety in your everyday life.',
    duration: '6 Weeks',
    category: 'Anxiety',
    benefits: [
    ...
    modules: [
      { title: 'What Is Anxiety?', description: 'Explore the nature of anxiety, its purpose, and why it can spiral out of control.', duration: 'Week 1', content: 'Anxiety is a natural alarm system — but sometimes the alarm misfires. We explore the neuroscience of anxiety and map out your personal anxiety cycle.' },
      { title: 'Identifying Your Triggers', description: 'Learn to recognize specific people, places, and thoughts that activate your anxiety.', duration: 'Week 2', content: 'Using a structured trigger journal, you will identify the specific situations and thought patterns that consistently activate your anxiety response.' },
      { title: 'Challenging Anxious Thoughts', description: 'Apply CBT techniques to test and reframe catastrophic thinking.', duration: 'Week 3', content: 'We introduce thought records and the Socratic questioning method to challenge irrational beliefs driving your anxiety.' },
      { title: 'Exposure & Acceptance', description: 'Gradually face feared situations to reduce avoidance behaviors.', duration: 'Week 4', content: 'Avoidance keeps anxiety alive. We build a personalized exposure hierarchy and practice facing feared situations in a safe, graduated way.' },
      { title: 'Body-Based Techniques', description: 'Use somatic exercises to calm your nervous system during acute anxiety.', duration: 'Week 5', content: 'We practice physiological techniques including the physiological sigh, cold water techniques, and body scanning to interrupt physical anxiety symptoms.' },
      { title: 'Your Long-Term Anxiety Plan', description: 'Consolidate your skills and build a sustainable anxiety management lifestyle.', duration: 'Week 6', content: 'You will create a comprehensive personal Anxiety Action Plan, complete with warning signs, coping tools, and strategies for maintaining gains.' }
    ],
    isActive: true
  }
];
...
/**
 * Auto-seeds the database with essential Services and Programs 
 * if the collections are empty. Safe to call on every server startup.
 */
const autoSeed = async () => {
  try {
    ...
    if (serviceCount === 0) {
      ...
      console.log(`[AutoSeed] Seeded ${services.length} services into database.`);
    }

    const programCount = await Program.countDocuments();
    if (programCount === 0) {
      await Program.insertMany(programs);
      console.log(`[AutoSeed] Seeded ${programs.length} programs into database.`);
    }
  } catch (err) {
    // Auto-seed should never crash the server — just log the error
    console.error('[AutoSeed] Error during auto-seed (non-fatal):', err.message);
  }
};
