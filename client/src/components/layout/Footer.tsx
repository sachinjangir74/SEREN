      ...
      <div className="container mx-auto px-4 max-w-7xl">
        <div className="grid grid-cols-2 md:grid-cols-5 lg:grid-cols-6 gap-x-8 gap-y-12 mb-16">
           ...
           <div>
              ...
              <ul className="space-y-4 text-sm font-medium text-slate-400">
                 <li><Link to="/assessment/anxiety" onClick={() => window.scrollTo(0, 0)} className="hover:text-teal-400 transition-colors">Anxiety Test</Link></li>
                 <li><Link to="/assessment/depression" onClick={() => window.scrollTo(0, 0)} className="hover:text-teal-400 transition-colors">Depression Test</Link></li>
                 <li><Link to="/assessment/stress" onClick={() => window.scrollTo(0, 0)} className="hover:text-teal-400 transition-colors">Stress Level Test</Link></li>
                 <li><Link to="/assessment/ptsd" onClick={() => window.scrollTo(0, 0)} className="hover:text-teal-400 transition-colors">PTSD Evaluation</Link></li>
              </ul>
           </div>
        </div>
