          ...
          {servicesList.map((service, index) => (
            <Link to={`/services/${service.slug}`} key={index} className="block">
              <motion.div
                ...
                whileHover={{ y: -8 }}
                className="bg-white dark:bg-gray-800 rounded-3xl overflow-hidden shadow-xl shadow-teal-900/5 border border-gray-100 dark:border-gray-700 flex flex-col group cursor-pointer h-full"
              >
